...
<html><head><title>PCMS - Server Management</title><link rel="stylesheet" type="text/css" href="css/main.css" />
<?php Session::UserCssRedirOrDie($u, $redir); ?><script type="text/javascript" src="js/common.js"></script>
</head><body><div class="main"><div class="header"><div class="ltext">Server Management</div><div class="rtext">
...
<!-- start content -->
This section will contain server management functionality.
