...
<html><head><title>PCMS - Invoice Management</title><link rel="stylesheet" type="text/css" href="css/main.css" />
<?php Session::UserCssRedirOrDie($u, $redir); ?><script type="text/javascript" src="js/common.js"></script>
</head><body><div class="main"><div class="header"><div class="ltext">Invoice Management</div><div class="rtext">
...
<!-- start content -->
This section will contain invoice generation capabilities.
